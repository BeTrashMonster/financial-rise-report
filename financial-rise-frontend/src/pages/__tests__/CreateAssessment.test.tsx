...
describe('CreateAssessment', () => {
  ...
  it.skip('should show validation error for invalid email', { timeout: 15000 }, async () => {
    const user = userEvent.setup();
    renderWithRouter();
  ...
  it.skip('should show validation error for client name exceeding max length', { timeout: 15000 }, async () => {
    const user = userEvent.setup();
    renderWithRouter();
  ...
  it.skip('should display error message when API call fails', { timeout: 15000 }, async () => {
    const user = userEvent.setup();
